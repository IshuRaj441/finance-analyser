...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'Finance Analyser'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Application version for tracking and monitoring
    |
    */
    ...
    */
    ...
    'features' => [
        'telemetry' => env('ENABLE_TELEMETRY', false),
        'debug_toolbar' => env('ENABLE_DEBUG_TOOLBAR', false),
        'api_documentation' => env('ENABLE_API_DOCS', true),
        'maintenance_mode' => env('MAINTENANCE_MODE', false),
        'new_user_registration' => env('ALLOW_REGISTRATION', true),
